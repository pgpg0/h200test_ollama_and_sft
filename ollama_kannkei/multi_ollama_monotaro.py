...
# --- 設定項目 ---
INPUT_DIR = Path('/home/ubuntu/client/Data_azami/input_data/monotaro')
...
def main():
    ...
    for csv_path in csv_files:
        ...
        for _, row in df.iterrows():
            ...
            feature_summary = row.get('productfeature', '')
            detailed_specs = row.get('キーワード2', '')
            product_info = f"商品名: {product_name}\n\n製品概要:\n{feature_summary}\n\n仕様詳細:\n{detailed_specs}"
            base_result_data = {"product_name": product_name, "product_feature_text": feature_summary, "detailed_specs_text": detailed_specs}
    ...
    print(f"Format 3: Total products to process: {len(all_products)}")

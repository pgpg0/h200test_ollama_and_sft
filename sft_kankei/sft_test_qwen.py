...
# 3. モデル
model_name = "/home/ubuntu/client/Data_azami/code/sft/Qwen4b-base" # <--使用するモデルを変える場合はここを参照
...
# 7. 評価と訓練 (変更なし)
print("Before training:", trainer.evaluate()) # 最初の評価は時間がかかるのでスキップしてもOK
trainer.train()
